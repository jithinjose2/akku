...
function updateMBTServiceAlerts() {
	...
	$.getJSON('/proxy?url=https://traintime.lirr.org/api/TrainTime%3Fapi_key=' + mtaAPIKey + '%26startsta=' + sStation + '%26endsta=' + eStation + '%26year=' + yyyy + '%26month='+ mm +'%26day='+ dd +'%26hour='+ hour +'%26minute='+ min +'%26datoggle=d', function(data) {
