...
function updateMBTAServiceAlerts_UpadteOne( index, alertID, defaultText )
{
	...
	var alertURL = '/proxy?url=http://realtime.mbta.com/developer/api/v2/ALERTBYID%3Fapi_key=' + mbtaAPIKey + '%26id=' + alertID + '%26format=json';
...
function updateMBTAServiceAlerts() {
	...
	var url = '/proxy?url=http://realtime.mbta.com/developer/api/v2/ALERTHEADERSBYROUTE%3Fapi_key=' + mbtaAPIKey + '%26route=' + mbtaRoute + '%26format=json';
